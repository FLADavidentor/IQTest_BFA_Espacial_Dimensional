...
import com.iqtest.bfaespacial.repository.ConfiguracionSubtestRepository;
...
public class SubtestService {
    ...
    private final com.iqtest.bfaespacial.service.AuditoriaService auditoria;
    ...
    public SubtestService(EjecucionSubtestRepository ejecucionRepo, RespuestaRepository respuestaRepo,
                          ...
                          com.iqtest.bfaespacial.service.AuditoriaService auditoria,
                          EntityManager em) {
